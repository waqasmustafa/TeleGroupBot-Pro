...
class Member extends Home
{
    public function __construct()
    {
        ...
        $this->razorpay_class_ecommerce = null;
        $this->paystack_class_ecommerce = null;
        $this->mollie_class_ecommerce = null;
        $this->yoomoney = null;
        $this->provider = null;
    }
    ...
    public function general_settings_action(Request $request)
    {
        ...
        [
            ...
            'sender_email' => 'nullable|sometimes',
            'sender_name' => 'nullable|sometimes'
        ];
        ...
        if ($request->file('logo')) {
            ...
            if(env('AWS_UPLOAD_ENABLED')){
               try {
                ...
                $file->move(public_path('storage/agency'), $filename);
        ...
        $email_settings = [
            'default' => $request->default_email ?? null,
