...
class Subscription extends Home
{
    ...
    public function save_user(Request $request)
    {
        ...
        [
            ...
            'package_id' => 'nullable|sometimes|integer',
            'status' => 'required|sometimes|boolean',
            'user_type' => 'required|string',
            'expired_date' => 'nullable|sometimes|date',
        ];
        ...
        // Set package_id to 0 (no package requirement)
        $validate_data['package_id'] = 0;
        ...
        if(!isset($request->id)) {
            ...
            // Set expiry date to far future (2099-12-31) to effectively disable expiry
            $validate_data['expired_date'] = '2099-12-31 23:59:59';
        }
        ...
        if(!isset($validate_data['expired_date'])) unset($validate_data['expired_date']);
