...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::post('mtproto/inbox/delete', [MTProtoController::class, 'deleteMessage'])->name('inbox.delete');
    Route::post('mtproto/inbox/read', [MTProtoController::class, 'markAsRead'])->name('inbox.read');
});
