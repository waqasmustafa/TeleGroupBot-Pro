...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" dir="{{config('app.localeDirection')}}">
  ...
  <body class="{{config('app.localeDirection')}}">
    <div class="container-fluid">
      <div class="row">
          <div class="col-12">
              <a class="text-center" href="{{ url('/') }}"><img  src="{{config('app.logo')}}" class="mt-4" width="200" alt="<?php echo config('product_name');?>"></a> :: <a style="color:red;" href="https://cutt.ly/PLFZenO" target="_blank">NULLED Web Community</a><br><br>
           </div>
