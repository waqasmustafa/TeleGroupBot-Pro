            ...
            <div id="sidebar" <?php if(!in_array($route_name,$full_width_page_routes)) echo "class='active'";?>>
                <div class="sidebar-wrapper active">
                    ...
                    if($is_admin){
                        ...
                        $admin_menus[1] = ['selected' => ['general-settings'], 'href' => route('general-settings'),'icon' => 'settings-1.png', 'title' => __('Settings')];
                    ...
                    $sidebar_menu_items['main'] = [
                        ...
                        'sidebar-items' =>  [
                            ...
                            3 => [
                                'selected' => ['mtproto.accounts.index', 'mtproto.accounts.create', 'mtproto.verify.otp'],
                                'href' => route('mtproto.accounts.index'),
                                'icon' => 'telegram.png',
                                'title' => __('Telegram Account')
                            ],
                            4 => [
                                'selected' => ['mtproto.contacts.index'],
                                'href' => route('mtproto.contacts.index'),
                                'icon' => 'meeting.png',
                                'title' => __('Contacts')
                            ],
                            5 => [
                                'selected' => ['mtproto.templates.index'],
                                'href' => route('mtproto.templates.index'),
                                'icon' => 'chat-1.png',
                                'title' => __('Message Templates')
                            ],
                            6 => [
                                'selected' => ['mtproto.campaigns.index'],
                                'href' => route('mtproto.campaigns.index'),
                                'icon' => 'send-2.png',
                                'title' => __('Bulk DM Campaigns')
                            ],
                            7 => [
                                'selected' => ['mtproto.inbox'],
                                'href' => route('mtproto.inbox'),
                                'icon' => 'chat.png',
                                'title' => __('Unified Inbox')
                            ]
                        ],
                    ];
