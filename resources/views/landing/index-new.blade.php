...
@section('content')
  ...
  $typingKeywords = [
    __("Account Manager"),
    __('Campaign Specialist'),
    __('Bulk Messenger'),
    __('Support Agent'),
    __('Marketing Expert'),
    __('Promotion Specialist')
  ];
      ...
      <div class="row">
        <div class="col-lg-6 col-md-12"  data-aos="fade-right" data-aos-duration="1500">
          ...
          <div class="banner_text">
            ...
            <!-- p -->
            <h4 class="mt-4 mb-4">{{__("Advanced Telegram MTProto Integration")}}</h4>
            <p>{!!__("Directly manage Telegram accounts, import contacts, and run powerful messaging campaigns with state-of-the-art MTProto technology.",['appname'=>config('app.name'),'linebreak'=>'<br>'])!!}
            </p>
          </div>
