...
<script type="text/javascript">
    ...
    var global_url_register = '{{ Route::has('register') ? route('register') : '#' }}';
    ...
    var telegram_connect_bot_url_delete = '';
    var telegram_connect_bot_url_sync = '';
    ...
    var common_function_url_get_email_profile_dropdown = '';
    ...
    var telegram_group_manager_url_set_active_group_tab_menu_session = '';
    var telegram_group_manager_url_set_active_bot_session = '';
    ...
    var telegram_group_list_subscriber_url_data = '';
    var telegram_campaign_list_data = '';
    var telegram_group_filtering_message = '';
    var telegram_group_list_subscriber_url_delete_subscriber = '';
    var telegram_group_activity_chart_title = '{{ __("Members") }}';

    var telegram_group_mute_chat_member = '';
    var telegram_group_banned_chat_member = '';
    var telegram_group_unban_chat_member = '';
    var telegram_group_unmute_chat_member = '';
    var telegram_group_edit_campaign = '';
    var telegram_group_show_subscriber_message = '';

    var subscription_list_package_url_data = '';
    var subscription_list_package_url_update = '';
    var subscription_list_package_url_delete = '';
    ...
    var member_transaction_log_url_data= '';
    var member_transaction_log_manual_url_data= '';
    var member_payment_buy_package_url = '';
    ...
    var member_settings_list_api_settings_url_data = '';
    var member_settings_list_video_tutorial_data = '';
    var member_settings_list_api_settings_url_update_data = '';
    var member_settings_list_video_update_data = '';
    var video_tutorial_update_data_action = '';
    var member_settings_list_api_settings_url_save = '';
    var member_settings_list_api_log_url_data = '';

    var manual_payment_upload_file_route = '';
    var manual_payment_submission_route = '';
    var manual_payment_upload_file_delete_route = '';
    var manual_payment_handle_action_route = '';
